namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAveragePriceCalcUsrYachtMethodsWrapper

	/// <exclude/>
	public class UsrAveragePriceCalcUsrYachtMethodsWrapper : ProcessModel
	{

		public UsrAveragePriceCalcUsrYachtMethodsWrapper(Process process)
			: base(process) {
